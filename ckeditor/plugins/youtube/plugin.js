                                                                    ...
                                                                    [
                                                                        {
                                                                            ...
                                                                            onChange: function(api)
                                                                            {
                                                                                ...
                                                                                if (this.getValue().length > 0)
                                                                                {
                                                                                    ...
                                                                                    var flg_video = this.getDialog().getValueOf('youtubePlugin', 'txtUrl');

                                                                                    if (ytVidId(flg_video)) {
                                                                                        var content = '';
                                                                                        var url = this.getDialog().getValueOf('youtubePlugin', 'txtUrl');
                                                                                        var width = this.getDialog().getValueOf('youtubePlugin', 'txtWidth');
                                                                                        var height = this.getDialog().getValueOf('youtubePlugin', 'txtHeight');
                                                                                        var related = true;
                                                                                        var video = url.match(/(v=|\/)([\w-]+)(&.+)?$/);

                                                                                        if (this.getDialog().getContentElement('youtubePlugin', 'chkSecure').getValue() === true)
                                                                                        {
                                                                                            url = 'https://';
                                                                                        }
                                                                                        else {
                                                                                        ...
                                                                                        if (this.getDialog().getContentElement('youtubePlugin', 'chkPrivacy').getValue() === true)
                                                                                        {
                                                                                        ...
                                                                                        if (this.getDialog().getContentElement('youtubePlugin', 'chkRelated').getValue() === false)
                                                                                        {
                                                                                            url += '?rel=0';
                                                                                            related = false;
                                                                                        ...
                                                                                        if (this.getDialog().getContentElement('youtubePlugin', 'chkOlderCode').getValue() === true)
                                                                                        {
