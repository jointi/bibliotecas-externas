...
ATTENTION: The trailing slash is required.
*/
$baseDir = $_SERVER['DOCUMENT_ROOT']."/".$config['upload_path']."/ckfinder/";
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
//		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
                'allowedExtensions' => '7z,aiff,asf,avi,csv,doc,docx,fla,flv,gz,gzip,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
